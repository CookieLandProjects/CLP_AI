...
//	curTemplate->m_parameters[1] = Parameter::INT;
  ...
  curTemplate->m_uiStrings[2] = " starting points.";
	...
	curTemplate = &m_actionTemplates[ScriptAction::PLAYER_HUNT_TYPE];
	curTemplate->m_internalName = "PLAYER_HUNT_TYPE";
	curTemplate->m_uiName = "Player/Hunt/Set object types to hunt.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::SIDE;
	curTemplate->m_parameters[1] = Parameter::OBJECT_TYPE;
	curTemplate->m_numUiStrings = 3;
	...
	curTemplate->m_uiStrings[2] = " begin hunting.";

	curTemplate = &m_actionTemplates[ScriptAction::TEAM_HUNT_TYPE];
	curTemplate->m_internalName = "TEAM_HUNT_TYPE";
	curTemplate->m_uiName = "Team/Hunt/Set object types to hunt.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::TEAM;
	curTemplate->m_parameters[1] = Parameter::OBJECT_TYPE;
	curTemplate->m_numUiStrings = 3;
	...
	curTemplate = &m_actionTemplates[ScriptAction::PLAYER_HUNT_AREA];
	curTemplate->m_internalName = "PLAYER_HUNT_AREA";
	curTemplate->m_uiName = "Player/Hunt/Set units inside an area to hunt.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::SIDE;
	curTemplate->m_parameters[1] = Parameter::TRIGGER_AREA;
	curTemplate->m_numUiStrings = 3;
	curTemplate->m_uiStrings[0] = " ";
	curTemplate->m_uiStrings[1] = "'s units inside ";
	curTemplate->m_uiStrings[2] = " begin hunting.";

	curTemplate = &m_actionTemplates[ScriptAction::TEAM_CUSTOM_COLOR];
	curTemplate->m_internalName = "TEAM_CUSTOM_COLOR";
	curTemplate->m_uiName = "User/Flash/Set a team to use a special indicator color.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::TEAM;
	curTemplate->m_parameters[1] = Parameter::COLOR;
	curTemplate->m_numUiStrings = 3;
	...
	curTemplate = &m_actionTemplates[ScriptAction::PLAYER_CUSTOM_COLOR];
	curTemplate->m_internalName = "PLAYER_CUSTOM_COLOR";
	curTemplate->m_uiName = "User/Flash/Set a player to use a special indicator color.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::SIDE;
	curTemplate->m_parameters[1] = Parameter::COLOR;
	curTemplate->m_numUiStrings = 3;
	...
	curTemplate = &m_actionTemplates[ScriptAction::AI_PLAYER_ROTATE_BUILDLIST_FROM_ID];
	curTemplate->m_internalName = "AI_PLAYER_ROTATE_BUILDLIST_FROM_ID";
	curTemplate->m_uiName = "Skirmish Only/ID BuildList/Rotate a build list around its axis.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::INT;
	curTemplate->m_parameters[1] = Parameter::REAL;
	curTemplate->m_numUiStrings = 3;
	curTemplate->m_uiStrings[0] = "Rotate build list with ID ";
	curTemplate->m_uiStrings[1] = " around its axis by ";
	curTemplate->m_uiStrings[2] = " degrees.";

	curTemplate = &m_actionTemplates[ScriptAction::CREATE_WAYPOINT_LOCATION];
	curTemplate->m_internalName = "CREATE_WAYPOINT_LOCATION";
	curTemplate->m_uiName = "Waypoints/Create/Create a waypoint at a specific location.";
	curTemplate->m_numParameters = 7;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::COORD3D;
	curTemplate->m_parameters[2] = Parameter::TEXT_STRING;
	curTemplate->m_parameters[3] = Parameter::TEXT_STRING;
	curTemplate->m_parameters[4] = Parameter::TEXT_STRING;
	curTemplate->m_parameters[5] = Parameter::BOOLEAN;
	curTemplate->m_parameters[6] = Parameter::BOOLEAN;
	curTemplate->m_numUiStrings = 7;
	curTemplate->m_uiStrings[0] = "Create a new waypoint named ";
	curTemplate->m_uiStrings[1] = " at ";
	curTemplate->m_uiStrings[2] = ", with properties:\nLabel1:";
	curTemplate->m_uiStrings[3] = "\nLabel2: ";
	curTemplate->m_uiStrings[4] = "\nLabel3: ";
	curTemplate->m_uiStrings[5] = "\nBi-Directional: ";
	curTemplate->m_uiStrings[6] = "\nSnapping to ground height: ";

	curTemplate = &m_actionTemplates[ScriptAction::CREATE_WAYPOINT_UNIT];
	curTemplate->m_internalName = "CREATE_WAYPOINT_UNIT";
	curTemplate->m_uiName = "Waypoints/Create/Create a waypoint at a unit's location.";
	curTemplate->m_numParameters = 6;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::UNIT;
	curTemplate->m_parameters[2] = Parameter::TEXT_STRING;
	...
	curTemplate->m_uiStrings[0] = "Create a new waypoint named ";
	curTemplate->m_uiStrings[1] = " at ";
	curTemplate->m_uiStrings[2] = "'s location, with properties:\nLabel1:";
	curTemplate->m_uiStrings[3] = "\nLabel2: ";
	curTemplate->m_uiStrings[4] = "\nLabel3: ";
	curTemplate->m_uiStrings[5] = "\nBi-Directional: ";

	curTemplate = &m_actionTemplates[ScriptAction::CREATE_WAYPOINT_TEAM];
	curTemplate->m_internalName = "CREATE_WAYPOINT_TEAM";
	curTemplate->m_uiName = "Waypoints/Create/Create a waypoint at a team's location.";
	curTemplate->m_numParameters = 6;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::TEAM;
	curTemplate->m_parameters[2] = Parameter::TEXT_STRING;
	...
	curTemplate = &m_actionTemplates[ScriptAction::CREATE_WAYPOINT_TYPE];
	curTemplate->m_internalName = "CREATE_WAYPOINT_TEAM";
	curTemplate->m_uiName = "Waypoints/Create/Create a waypoint at an objectType's location.";
	curTemplate->m_numParameters = 7;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::OBJECT_TYPE;
	curTemplate->m_parameters[2] = Parameter::TEXT_STRING;
	...
	curTemplate->m_parameters[4] = Parameter::TEXT_STRING;
	curTemplate->m_parameters[5] = Parameter::BOOLEAN;
	curTemplate->m_parameters[6] = Parameter::INT;
	curTemplate->m_numUiStrings = 8;
	curTemplate->m_uiStrings[0] = "Create a new waypoint named ";
	curTemplate->m_uiStrings[1] = " at a(n) ";
	curTemplate->m_uiStrings[2] = "'s location, with properties:\nLabel1:";
	curTemplate->m_uiStrings[3] = "\nLabel2: ";
	curTemplate->m_uiStrings[4] = "\nLabel3: ";
	curTemplate->m_uiStrings[5] = "\nBi-Directional: ";
	curTemplate->m_uiStrings[6] = "\nSelection Mode: ";
	curTemplate->m_uiStrings[7] = " (0: closest, 1: farthest, 2: random)";

	curTemplate = &m_actionTemplates[ScriptAction::REMOVE_WAYPOINT];
	curTemplate->m_internalName = "REMOVE_WAYPOINT";
	curTemplate->m_uiName = "Waypoints/Remove/Remove a waypoint.";
	curTemplate->m_numParameters = 1;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_numUiStrings = 2;
	curTemplate->m_uiStrings[0] = "Remove ";
	curTemplate->m_uiStrings[1] = ".";

	curTemplate = &m_actionTemplates[ScriptAction::SET_WAYPOINT_LINK];
	curTemplate->m_internalName = "SET_WAYPOINT_LINK";
	curTemplate->m_uiName = "Waypoints/Link/Link a waypoint to another.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::WAYPOINT;
	curTemplate->m_numUiStrings = 3;
	curTemplate->m_uiStrings[0] = "Link ";
	curTemplate->m_uiStrings[1] = " to ";
	curTemplate->m_uiStrings[2] = " (if bi-directional, create a link back and forth).";

	curTemplate = &m_actionTemplates[ScriptAction::REMOVE_WAYPOINT_LINK];
	curTemplate->m_internalName = "REMOVE_WAYPOINT_LINK";
	curTemplate->m_uiName = "Waypoints/Link/Unlink a waypoint from another.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::WAYPOINT;
	curTemplate->m_numUiStrings = 3;
	curTemplate->m_uiStrings[0] = "Unlink ";
	curTemplate->m_uiStrings[1] = " from ";
	curTemplate->m_uiStrings[2] = " (unlink both directions).";

	curTemplate = &m_actionTemplates[ScriptAction::SET_WAYPOINT_LABELS];
	curTemplate->m_internalName = "SET_WAYPOINT_LABELS";
	curTemplate->m_uiName = "Waypoints/Properties/Set a waypoint's path labels.";
	curTemplate->m_numParameters = 4;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::TEXT_STRING;
	curTemplate->m_parameters[2] = Parameter::TEXT_STRING;
	curTemplate->m_parameters[3] = Parameter::TEXT_STRING;
	curTemplate->m_numUiStrings = 4;
	curTemplate->m_uiStrings[0] = "Set the labels for ";
	curTemplate->m_uiStrings[1] = " to:\nLabel1:";
	curTemplate->m_uiStrings[2] = "\nLabel2:";
	curTemplate->m_uiStrings[3] = "\nLabel3:";

	curTemplate = &m_actionTemplates[ScriptAction::CLEAR_WAYPOINT_LABELS];
	curTemplate->m_internalName = "CLEAR_WAYPOINT_LABELS";
	curTemplate->m_uiName = "Waypoints/Properties/Clear a waypoint's path labels.";
	curTemplate->m_numParameters = 4;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::BOOLEAN;
	curTemplate->m_parameters[2] = Parameter::BOOLEAN;
	curTemplate->m_parameters[3] = Parameter::BOOLEAN;
	curTemplate->m_numUiStrings = 4;
	curTemplate->m_uiStrings[0] = "Clear the labels for ";
	curTemplate->m_uiStrings[1] = ".\nLabel1:";
	curTemplate->m_uiStrings[2] = "\nLabel2:";
	curTemplate->m_uiStrings[3] = "\nLabel3:";

	curTemplate = &m_actionTemplates[ScriptAction::RELOCATE_WAYPOINT_LOCATION];
	curTemplate->m_internalName = "RELOCATE_WAYPOINT_LOCATION";
	curTemplate->m_uiName = "Waypoints/Relocate/Relocate a waypoint to a specific location.";
	curTemplate->m_numParameters = 3;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::COORD3D;
	curTemplate->m_parameters[2] = Parameter::BOOLEAN;
	curTemplate->m_numUiStrings = 4;
	curTemplate->m_uiStrings[0] = "Relocate ";
	curTemplate->m_uiStrings[1] = " to ";
	curTemplate->m_uiStrings[2] = ", snapping to the grid ";
	curTemplate->m_uiStrings[3] = ".";

	curTemplate = &m_actionTemplates[ScriptAction::RELOCATE_WAYPOINT_UNIT];
	curTemplate->m_internalName = "RELOCATE_WAYPOINT_UNIT";
	curTemplate->m_uiName = "Waypoints/Relocate/Relocate a waypoint to a unit's location.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::UNIT;
	curTemplate->m_numUiStrings = 3;
	...
	curTemplate = &m_actionTemplates[ScriptAction::RELOCATE_WAYPOINT_TEAM];
	curTemplate->m_internalName = "RELOCATE_WAYPOINT_TEAM";
	curTemplate->m_uiName = "Waypoints/Relocate/Relocate a waypoint to a team's location.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::TEAM;
	curTemplate->m_numUiStrings = 3;
	...
	curTemplate = &m_actionTemplates[ScriptAction::RELOCATE_WAYPOINT_TYPE];
	curTemplate->m_internalName = "RELOCATE_WAYPOINT_TEAM";
	curTemplate->m_uiName = "Waypoints/Relocate/Relocate a waypoint to an objectType's location.";
	curTemplate->m_numParameters = 3;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::OBJECT_TYPE;
	curTemplate->m_parameters[2] = Parameter::BOOLEAN;
	curTemplate->m_numUiStrings = 4;
	curTemplate->m_uiStrings[0] = "Relocate ";
	curTemplate->m_uiStrings[1] = " to a(n) ";
	curTemplate->m_uiStrings[2] = " with selecion mode ";
	curTemplate->m_uiStrings[3] = " (0: closest, 1: farthest, 2: random).";

	curTemplate = &m_actionTemplates[ScriptAction::SET_WAYPOINT_BIDIRECTIONAL];
	curTemplate->m_internalName = "SET_WAYPOINT_BIDIRECTIONAL";
	curTemplate->m_uiName = "Waypoints/Properties/Set a waypoint to be bi-directional.";
	curTemplate->m_numParameters = 2;
	curTemplate->m_parameters[0] = Parameter::WAYPOINT;
	curTemplate->m_parameters[1] = Parameter::BOOLEAN;
	curTemplate->m_numUiStrings = 3;
