...
*/
			...
			if (isSkirmishOrSkirmishReplay)
			{
				...
				switch (slot->getState()) {
					...
					case SLOT_MOD_BRUTAL_AI: d.setInt(TheKey_skirmishDifficulty, DIFFICULTY_BRUTAL); break;
					case SLOT_MOD_ABSURD_AI: d.setInt(TheKey_skirmishDifficulty, DIFFICULTY_ABSURD); break;
					case SLOT_MOD_INHUMANE_AI: d.setInt(TheKey_skirmishDifficulty, DIFFICULTY_INHUMANE); break;
